...
$sql = "SELECT DATE_FORMAT(tanggal, '%m/%Y') tanggal,namaAgen , kecamatan , sum(jumlah) jumlah FROM vwDisribusi WHERE left(tanggal,7) = ? GROUP BY namaAgen , kecamatan";
...
<table>
    <thead>
    <tr>
    <td colspan="3"><h4>DATA DISTRIBUSI PER AGEN PER KECAMATAN</h4></td>
    </tr>
    <tr>
